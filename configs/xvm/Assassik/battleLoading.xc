 ...
 */
{
  "battleLoading": {
    ...
    "formatLeftNick": "<img src='xvm://res/icons/lang/{{language|default}}.png' width='16' height='13'> {{name%.16s~..}}<font alpha='#A0'>{{clan}}</font>",
    // Display format for the right panel (macros allowed, see readme-en.txt).
    // Формат отображения для правой панели (допускаются макроподстановки, см. readme-ru.txt).
    "formatRightNick": "{{name%.16s~..}}<font alpha='#A0'>{{clan}}</font> <img src='xvm://res/icons/lang/{{language|default}}.png' width='16' height='13'>",
