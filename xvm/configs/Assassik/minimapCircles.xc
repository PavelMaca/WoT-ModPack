 ...
 */
{
    "circles": {
        ...
        "view": [
            // Main circles:
            // Основные круги:
            { "enabled":  true, "distance": "blindarea", "scale": 1, "thickness": 0.75, "alpha": 45, "color": "0x60FF00" },
            { "enabled":  true, "distance": 445,         "scale": 1, "thickness": 0.75, "alpha": 45, "color": "0xDD4444" },
            // Additional circles:
